...
import (
	...
	"github.com/lawyky/fx-admin/models"
	"github.com/lawyky/fx-admin/models/dto"
	"github.com/lawyky/fx-admin/pkg/hash"
	"github.com/lawyky/fx-admin/pkg/snowflake"
)
...
func (a UserService) Create(user *models.User) (id string, err error) {
	...
	user.ID = snowflake.MustString()

	for _, userRole := range user.UserRoles {
		userRole.ID = snowflake.MustString()
...
func (a UserService) Update(id string, user *models.User) error {
	...
	for _, aUserRole := range aUserRoles {
		aUserRole.ID = snowflake.MustString()
		aUserRole.UserID = id
